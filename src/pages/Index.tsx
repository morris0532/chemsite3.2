...
const jsonLdEn = {
  ...
  logo: "https://sinopeakchem.com/logo.webp",
    ...
    >
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <picture>
            <source media="(max-width: 480px)" srcSet={HERO_IMG + "?w=480&q=65"} />
            <source media="(max-width: 768px)" srcSet={HERO_IMG + "?w=768&q=70"} />
            <source media="(max-width: 1024px)" srcSet={HERO_IMG + "?w=1024&q=75"} />
            <img 
              src={HERO_IMG + "?w=1600&q=80"} 
              alt="Sinopeakchem Strategic Chemical Supply" 

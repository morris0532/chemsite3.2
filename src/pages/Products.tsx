...
export default function ProductsPage() {
  ...
  const { products: markdownProducts, isLoading } = useMarkdownContent(currentLocale);
  const { products: enProducts } = useMarkdownContent('en');

  const currentProducts = useMemo(() => {
    if (currentLocale === 'en') return markdownProducts;
    const baseProducts = [...enProducts];
    return baseProducts.map(enP => {
      const translated = markdownProducts.find((p: any) => 
  ...
  }, [currentLocale, markdownProducts, enProducts]);
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <div className="flex items-center text-sm text-[#0066B3] font-medium">

...
| **Iron Content (as Fe)** | ≤ 0.003% | Prevents unwanted coloration in silicates and phosphates. |
...
3.  **Physical Form Compatibility**: Choose **Soda Ash Light** for rapid aqueous reactions or **Soda Ash Dense** for high-temperature furnace fusion.
...
9.  **World Bank.** "Global Chemical Industry Outlook: Supply Chain Resilience in Inorganic Salts." *World Bank Group*, 2024.
